...
def interactive_edge_detection(image_path):
    ...
    while True:
        ...
        if choice == "1":
            ...
            print("Adjust threshold values for Canny (default: 25 and 25):")
            ...
            display_image("Gaussian Smoothing Image", blurred)
            ...
            display_image("Median Filtering Image", median_filtered)
