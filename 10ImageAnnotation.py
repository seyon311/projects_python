...
cv2.circle(image_rgb, (center1_x, center1_y), 15, (0, 255, 0), -1) # Green circle in the center of the first rectangle
cv2.circle(image_rgb, (center2_x, center2_y), 15, (255, 0, 0), -1) # Red circle in the center of the second rectangle

cv2.line(image_rgb, (center1_x, center1_y), (center2_x, center2_y), (0, 255, 0), 3) # Green line connecting the centers of the two rectangles
...
plt.title("Annotated Image with Rectangles, Circles, Lines, and Arrows")
plt.axis("off")
plt.show()